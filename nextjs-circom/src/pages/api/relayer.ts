...
export default async function handler(req: NextApiRequest, res: NextApiResponse){
    ...
    try{
        ...
        const vk = fs.readFileSync(path.join(process.cwd(), "public", "assets", "circom", "main.groth16.vkey.json"), 'utf-8');
        // const vk = await fetch("/assets/circom/main.groth16.vkey.json")
        const params = {
            "proofType": "groth16",
            "vkRegistered": false,
            "proofOptions": {
